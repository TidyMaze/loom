...
class AppViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private fun mockApps(): List<AppEntry> {
        ...
        return listOf(
            ...
            // #2 — high score, red heat (habit, skipped today)
            AppEntry("com.google.android.youtube",        "YouTube",     score = 0.88f, launchCount = 80, lastLaunchedMillis = ago(5 * 60_000),       todayCount = 0,  dailyAvg = 5f),
            ...
            // #6 — low score, red heat
            AppEntry("com.google.android.calendar",       "Calendar",    score = 0.22f, launchCount = 12, lastLaunchedMillis = ago(4 * 3600_000L),    todayCount = 0,  dailyAvg = 2f),
            // #7 — very low score, amber heat
            AppEntry("com.android.settings",              "Settings",    score = 0.12f, launchCount = 7,  lastLaunchedMillis = ago(2 * 86400_000L),   todayCount = 1,  dailyAvg = 1.5f),
